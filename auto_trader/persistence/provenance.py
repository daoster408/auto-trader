...
SAFE_CONFIG_ALIASES = frozenset(
    {
        ...
        "CONSECUTIVE_SL_HALT",
        "SUPERVISOR_TICK_TIMEOUT_SECONDS",
        "AUTO_ENTRY_ENABLED",
        "AUTO_EXIT_ENABLED",
        ...
        "AI_RESEARCH_TIMEOUT_SECONDS",
        "AI_RESEARCH_OPENAI_TIMEOUT_SECONDS",
        "AI_RESEARCH_XAI_TIMEOUT_SECONDS",
        "AI_RESEARCH_ANTHROPIC_TIMEOUT_SECONDS",
        "AI_RESEARCH_GEMINI_TIMEOUT_SECONDS",
        "AI_PROVIDER_FAILURE_COOLDOWN_SECONDS",
        "AI_RESEARCH_MAX_CALLS_PER_DAY",
        "AI_PAID_PREFILTER_ENABLED",
        "AI_PAID_PREFILTER_MIN_REL_VOLUME",
        "AI_PAID_PREFILTER_STRONG_REL_VOLUME",
        "AI_PAID_PREFILTER_HIGH_BUFFER_PCT",
        "AI_PAID_PREFILTER_BLOCK_INVERSE_OVERLAP",
